...
class OrderExport extends CommonModels
{
    ...
    {
        return [
            [['conditions', 'parameter', 'order_data', 'merchant_id', 'AppID'], 'required', 'message' => '{attribute}不能为空'],
        ];
    }
